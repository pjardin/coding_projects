...
images_folder = "/Users/pascaljardin/Documents/greenScreenCap/monkey_test/images"
training_xml_path = "/Users/pascaljardin/Documents/greenScreenCap/monkey_test/train_data.xml"
testing_xml_path = "/Users/pascaljardin/Documents/greenScreenCap/monkey_test/test_data.xml"
...
# parts.
dlib.train_shape_predictor(training_xml_path, predictor_path, options)

# Now that we have a model we can test it.  dlib.test_shape_predictor()
# measures the average distance between a face landmark output by the
# shape_predictor and where it should be according to the truth data.
print("\nTraining accuracy: {}".format(
    dlib.test_shape_predictor(training_xml_path, predictor_path)))
